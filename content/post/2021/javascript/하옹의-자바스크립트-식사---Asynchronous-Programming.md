...
![동기와 비동기방식](./Eat_Javascript_Asynchronous_Programming/sync-async.png)
...
![Synchronous,Asynchronous별 스레드 차이](./Eat_Javascript_Asynchronous_Programming/sync-async-single-multi-thread-difference.jpg)
...
![event loop](./Eat_Javascript_Asynchronous_Programming/eventloop.png)
...
![Promise 처리 흐름](./Eat_Javascript_Asynchronous_Programming/promise처리흐름.svg)
...
![async function return1](./Eat_Javascript_Asynchronous_Programming/asyncFuncionReturnUndefined.png)
...
![async function return 2](./Eat_Javascript_Asynchronous_Programming/asyncFunctionReturnValue.png)
